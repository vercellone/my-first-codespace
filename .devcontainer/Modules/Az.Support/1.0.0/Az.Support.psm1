...
#
# Generated on: 03/27/2020 11:36:19
#
...
if ($module -ne $null -and $module.Version.ToString().CompareTo("1.7.4") -lt 0) 
{ 
    Write-Error "This module requires Az.Accounts version 1.7.4. An earlier version of Az.Accounts is imported in the current PowerShell session. Please open a new session before importing this module. This error could indicate that multiple incompatible versions of the Azure PowerShell cmdlets are installed on your system. Please see https://aka.ms/azps-version-error for troubleshooting information." -ErrorAction Stop 
} 
elseif ($module -eq $null) 
{ 
    Import-Module Az.Accounts -MinimumVersion 1.7.4 -Scope Global 
}
Import-Module (Join-Path -Path $PSScriptRoot -ChildPath Microsoft.Azure.PowerShell.Cmdlets.Support.dll)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB1kb2GCta5Y6Rc
# JHuW3KCF+/+lNkO6NTf9wGlsmkX7KqCCDYEwggX/MIID56ADAgECAhMzAAABUZ6N
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg1qGzddJe
# Wb8GgcvA+F5lFJBdZ89CGhwuZ4JoxGwg71MwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQBDbZqEHJAojhBDcXiW9amdor7EtU7ZkF3ucy5U5FPA
# vOS7jdT9j+9mOqCTqJ/hk4S2SwF1+LLCwW4/keavielaJk5E86YDHdvD0uCW8lGe
# 8mncwO1ikov1oN5wDxmg8n+30UvthKfCW0zOITqgb2wXUcgyMNNIkWKl1Lmmk3+2
# Ud0/2bNP2XeXQtKeIRL8mEEMhjQsR5m95CNovLuHnRwo730OXFtTQo/mJPiK3RLA
# QHFj/8kPnyZMPSyOLjqmsJrp8/GtjobMFmU+oeZ8+lXkW/TSCkDdy0imelJd/Pfl
# ASKGloonrDVSoNWM/fXncCrqjoxhRs2UW0OXUUSyR/2VoYIS5TCCEuEGCisGAQQB
# gjcDAwExghLRMIISzQYJKoZIhvcNAQcCoIISvjCCEroCAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIOVzzSsxkLMZXr+viLi41ApUTnUkIjzfVe96z4BS
# kjgoAgZee8CMmoMYEzIwMjAwMzI3MTE0NjI0LjE0MVowBIACAfSggdCkgc0wgcox
...
# VGltZS1TdGFtcCBQQ0EgMjAxMDANBgkqhkiG9w0BAQUFAAIFAOIoOUYwIhgPMjAy
# MDAzMjcxNjM1MThaGA8yMDIwMDMyODE2MzUxOFowdzA9BgorBgEEAYRZCgQBMS8w
# LTAKAgUA4ig5RgIBADAKAgEAAgIg1wIB/zAHAgEAAgIS9TAKAgUA4imKxgIBADA2
# BgorBgEEAYRZCgQCMSgwJjAMBgorBgEEAYRZCgMCoAowCAIBAAIDB6EgoQowCAIB
# AAIDAYagMA0GCSqGSIb3DQEBBQUAA4GBAI4mf3i8M9bWoIwD33o5H+uwEeyaAzzc
# lBnoTlp3NvpAEmGzQSegFz3fHRl+e9adDa5pimoqNc+NsDAiHyBInr9gRUXyBEL/
# 9gYoPj+svbWxQdhOz9kKM48wwli/NKWQsPxnqlvv9bwRbuRl7dSt1BUMXb4bqvxG
# xp303pV6N/3iMYIDDTCCAwkCAQEwgZMwfDELMAkGA1UEBhMCVVMxEzARBgNVBAgT
# Cldhc2hpbmd0b24xEDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29m
# dCBDb3Jwb3JhdGlvbjEmMCQGA1UEAxMdTWljcm9zb2Z0IFRpbWUtU3RhbXAgUENB
# IDIwMTACEzMAAAEb4iDN3Iqvi9kAAAAAARswDQYJYIZIAWUDBAIBBQCgggFKMBoG
# CSqGSIb3DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgGCldKq9b
# EHEWXPFCnjklNxB5LiIR+lt3hbzCa7wRA/AwgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
# AAEbMCIEICEoAjPc2G+HDR9Ev/t6zwMpxViUhyYAhUaxfh0FyExcMA0GCSqGSIb3
# DQEBCwUABIIBADdAE/1p6Gj4Tjj9lt5SELQKCvgepazNWMUAwUfRBbti5hFTLgTJ
# ZuLgRgub+o6/4Kqa0kZHn6FaO9SbhQEG/g4owg/p2NCYeFl0IsXt2xgA4b5SMULU
# ipfy91ABvGIWIxqDBaWKlhjQyLmeL3bMFsGyjs68q4VMyPlQtFT/Rw8Z+5QLPP8k
# 76+bZlJC19n4ztfiZ214lLBGkT2fRtyCIdMDHLo8uKHc2OyPbF+Kjwvu446QcEpq
# XaEWPmJIwHcogC37daoV1sT+VsxAF/XIgwxtiRPNNw31vytZXnFuXo/XyQ0GxOsK
# YgpNEekUnFRmQ2woFsn6b5fMJTGe5KIjKVM=
