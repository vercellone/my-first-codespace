Function Invoke-SQLBulkCopy {
    [cmdletBinding( DefaultParameterSetName = 'Instance',SupportsShouldProcess = $true,ConfirmImpact = 'High' )]
    param(
        [parameter( Position = 0,Mandatory = $true,ValueFromPipeline = $true,ValueFromPipelineByPropertyName= $true)]
        [System.Data.DataTable]
        $DataTable,

        [Parameter( ParameterSetName = 'Instance',Position = 1,Mandatory = $true,ValueFromPipeline = $false,ValueFromPipelineByPropertyName = $true)]
        [Alias( 'SQLInstance', 'Server', 'Instance' )]
        [string]
        $ServerInstance,

        [Parameter( ParameterSetName = 'Connection',Position = 1,Mandatory = $true,ValueFromPipeline = $false,ValueFromPipelineByPropertyName = $false,ValueFromRemainingArguments = $false )]
        ...
        [Parameter( ParameterSetName = 'Instance',Position = 4,Mandatory = $false)]
        [System.Management.Automation.PSCredential]
        $Credential,
    
        [Parameter( ParameterSetName = 'Instance',Position = 5,Mandatory = $false)]
        [Int32]
